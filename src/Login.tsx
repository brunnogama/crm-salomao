    ...
    <div className="min-h-screen flex w-full bg-white">
      ...
      <div className="hidden lg:flex w-1/2 relative bg-[#112240] items-center justify-center overflow-hidden">
        ...
        <div className="relative z-20 max-w-lg p-12 text-white animate-slideInRight">
          <div className="w-14 h-14 bg-white/10 rounded-2xl flex items-center justify-center mb-6 border border-white/20 backdrop-blur-sm shadow-2xl">
          ...
          <div className="w-20 h-1.5 bg-blue-500 rounded-full mb-6 shadow-lg shadow-blue-500/50"></div>
          ...
          {/* Cards Rearranjados (padding e gap reduzidos para caber tudo) */}
          <div className="space-y-2.5">
            
            <div className="flex items-center gap-4 p-2.5 rounded-lg bg-white/5 border border-white/10 hover:bg-white/10 transition-colors cursor-default backdrop-blur-sm">
            ...
            {/* Secretaria Executiva (Antiga Gestão Familiar) */}
            <div className="flex items-center gap-4 p-2.5 rounded-lg bg-white/5 border border-white/10 hover:bg-white/10 transition-colors cursor-default backdrop-blur-sm">
                <span className="w-2 h-8 bg-purple-500 rounded-full shadow-[0_0_10px_rgba(168,85,247,0.5)]"></span>
                <div>
                    <strong className="block text-sm text-white">Secretaria Executiva</strong>
                    <span className="text-xs text-gray-400">Demandas dos sócios</span>
                </div>
            </div>
            ...
            {/* NOVO: Operacional */}
            <div className="flex items-center gap-4 p-2.5 rounded-lg bg-white/5 border border-white/10 hover:bg-white/10 transition-colors cursor-default backdrop-blur-sm">
                <span className="w-2 h-8 bg-amber-500 rounded-full shadow-[0_0_10px_rgba(245,158,11,0.5)]"></span>
                <div>
                    <strong className="block text-sm text-white">Operacional</strong>
                    <span className="text-xs text-gray-400">Operacional do Escritório</span>
                </div>
            </div>
